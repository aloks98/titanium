...
import { useDataGrid } from '@/lib/base/data-grid/index';
      ...
      <DataGridTableBody>
        ...
        pagination?.pageSize ? (
          Array.from({ length: pagination.pageSize }).map((_, rowIndex) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: Skeleton rows are temporary placeholders without stable IDs
