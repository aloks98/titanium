...
import {
  ...
  CommandList,
  CommandSeparator,
} from '@/lib/base/command';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@/lib/base/dropdown-menu';
import { Popover, PopoverContent, PopoverTrigger } from '@/lib/base/popover';
import { Switch } from '@/lib/base/switch';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/lib/base/tooltip';
                  ...
                  <>
                    ...
                    <CommandList>
                      ...
                      {fields.map((item, index) => {
                            ...
                            >
                              {groupFields.map((field, fieldIndex) => {
                                ...
                                if (field.type === 'separator') {
                                  return (
                                    <CommandSeparator
                                      key={`separator-${field.key || fieldIndex}`}
                                    />
                                  );
                                }
                        ...
                        if (field.type === 'separator') {
                          return (
                            // biome-ignore lint/suspicious/noArrayIndexKey: Separators are static decorative elements without state
