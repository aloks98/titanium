...
describe('BreadcrumbList', () => {
  it('renders correctly', () => {
    render(<BreadcrumbList data-testid="breadcrumb-list">Content</BreadcrumbList>)
  ...
  it('accepts custom className', () => {
    render(<BreadcrumbList className="custom-list" data-testid="breadcrumb-list">Content</BreadcrumbList>)
...
describe('BreadcrumbItem', () => {
  ...
  it('accepts custom className', () => {
    render(<BreadcrumbItem className="custom-item" data-testid="breadcrumb-item">Item</BreadcrumbItem>)
...
describe('BreadcrumbLink', () => {
  ...
  it('accepts custom className', () => {
    render(<BreadcrumbLink className="custom-link" href="/test" data-testid="breadcrumb-link">Link</BreadcrumbLink>)
...
describe('BreadcrumbPage', () => {
  ...
  it('accepts custom className', () => {
    render(<BreadcrumbPage className="custom-page" data-testid="breadcrumb-page">Current Page</BreadcrumbPage>)
...
describe('BreadcrumbEllipsis', () => {
  ...
  it('accepts custom className', () => {
    ...
    expect(screen.getByTestId('breadcrumb-ellipsis')).toHaveClass('custom-ellipsis')
  })
})
