    ...
    scroll-behavior: smooth;
          ...
          <div className="mt-4 p-4 rounded-lg bg-muted/50 border">
            <p className="text-sm text-muted-foreground">
              ...
              Titanium UI exports CSS variables for theming. By mapping these to
              Tailwind's theme using{' '}
              <code className="px-1 py-0.5 rounded bg-muted text-xs font-mono">
                @theme inline
              </code>
              , you get full access to the theme colors with Tailwind utilities
              like{' '}
              <code className="px-1 py-0.5 rounded bg-muted text-xs font-mono">
                bg-primary
              </code>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            Wrap your app with the ThemeProvider to enable theming and dark mode
            support:
          </p>
          <CodeBlock
            title="src/App.tsx"
      ...
      <CardContent>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            ...
            definitions. If you're using path aliases, add the following to your{' '}
            <code className="px-1.5 py-0.5 rounded bg-muted text-sm font-mono">
              tsconfig.json
            </code>
            :
