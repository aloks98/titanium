...
export const dataGridDocumentation: ComponentDocumentation = {
  ...
  name: 'Data Grid',
  description:
    'A powerful data table component built on TanStack Table with sorting, filtering, pagination, and more.',
  ...
  api: [
    {
      component: 'DataGrid',
      description:
        'Main wrapper component that provides context for all child components.',
      props: [
        {
          name: 'table',
          type: 'Table<TData>',
      ...
      props: [
        {
          name: 'border',
          type: 'boolean',
          description: 'Show border around grid',
          defaultValue: 'true',
        },
        {
          name: 'className',
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          name: 'info',
          type: 'string',
          description: 'Info template with {from}, {to}, {count} placeholders',
        },
        {
          name: 'className',
          type: 'string',
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          name: 'filter',
          type: 'ReactNode',
          description: 'Filter component for dropdown',
        },
        {
          name: 'visibility',
          type: 'boolean',
          description: 'Show visibility toggle in menu',
        },
      ],
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: 'boolean',
          description: 'Enable column pinning',
          defaultValue: 'false',
        },
        {
          name: 'columnsMovable',
